...
if __name__ == '__main__':
    ...
    plt.plot(range(steps + 1), x[:, 0, 0], 'r-', label="true x -- dim 1")
    plt.plot(range(steps + 1), x[:, 1, 0], 'g-', label="true x -- dim 2")
    plt.plot(range(steps + 1), y[:, 0, 0], 'bx', label="y -- dim 1")
    plt.plot(range(steps + 1), y[:, 1, 0], 'bo', label="y -- dim 2")
    plt.plot(range(steps + 1), sest[:, 0, 0], 'r--', label="smooth 1")
    plt.plot(range(steps + 1), sest[:, 0, 1], 'g--', label="smooth 2")
    plt.legend()
    plt.show()
